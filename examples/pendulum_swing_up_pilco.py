...
from examples.utils import predict_trajectory_wrapper
...
with tf.Session() as sess:
    ...
    for rollouts in range(N):
        ...
        for t in range(0,len(X_new)):
            cur_rew.append(predict_trajectory_wrapper(pilco, X_new[t, 0:state_dim, None].transpose(), 0.0001 * np.eye(state_dim), T))
