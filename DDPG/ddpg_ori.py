...
flags.DEFINE_string('root_dir', os.path.dirname(os.path.realpath(__file__)), 'Root directory for writing logs/summaries/checkpoints.')
...
def train_eval(
    ...
    eval_env_name=None,
    env_load_fn=suite_gym.load,  # suite_mujoco.load,
    num_iterations=2000000,
