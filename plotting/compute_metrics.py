...
from plotting.plotter import MetricsCalculator
...
if __name__ == "__main__":
    ...
    all_trajectories = get_metrics(envs_names, envs, policies, impulse_input=-1.0)
    myMetrics = MetricsCalculator(envs_names)
    myMetrics(all_trajectories)
